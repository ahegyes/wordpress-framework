...
final class TermFieldSurfaceTest extends ObjectFieldSurfaceContractTestCase {
	protected function make_surface( ObjectMetaRepositoryInterface $repository ): TermFieldSurface {
		return new TermFieldSurface( repository: $repository );
	}
}
